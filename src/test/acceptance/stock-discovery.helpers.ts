...
import { mockAppleBasicFinancials, mockEmptySearchResult } from '../fixtures/mockStockData';
import type { FinnhubQuote, FinnhubSearchResponse } from '../../services/finnhub/types';
...
export function givenStockDataIsAvailableFor(searchResult: FinnhubSearchResponse, stockQuote: FinnhubQuote): void {
  server.use(
    ...
    http.get(`${BASE_URL}/stock/metric`, () => HttpResponse.json(mockAppleBasicFinancials))
  );
}
